module.exports = ({
    ...
    $deleteIn[30s]
    $deletecommand[29s]
$setUserVar[listmember;$message[1]]
$author[Langage Bump;https://cdn.discordapp.com/avatars/736555562472570981/0c97697752b378540ede2348452a276b.png?size=4096]
$description[<:member:741849422669021217> **The number of members when adding the server is now: \`$message[1]\` <:yes:772119320389484544>**]
$color[99aab5]
