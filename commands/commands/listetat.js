module.exports = ({
    ...
    $deleteIn[30s]
    $deletecommand[29s]
$setUserVar[listetat;$message[1]]
$author[Etat Bump;https://cdn.discordapp.com/avatars/736555562472570981/0c97697752b378540ede2348452a276b.png?size=4096]
$description[ **The Etat of the server in pub is now: \`$message[1]\` <:yes:772119320389484544>**]
$color[$message[1]]
